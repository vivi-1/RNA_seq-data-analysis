...
#import annotation
contents <- read.csv("/Users/weiwang/Desktop/GoEnrichment/Input/Pnic_up_GO.csv",header=T,sep=",")
term2name <- read.csv("/Users/weiwang/Desktop/GoEnrichment/Input/GOterms annotations.csv",header=T,sep=",")
term2gene <- read.csv("/Users/weiwang/Desktop/GoEnrichment/Input/GOterms_GeneList1.csv",header=T,sep=",")
...
ouf <- paste('Pnic_up_GO_Enricher.csv',sep ="\t")
# result
