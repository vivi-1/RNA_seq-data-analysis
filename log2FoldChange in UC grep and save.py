...
wb=xlwt.Workbook(currentDirectory_comparison+'/'+'log2FoldChange in C_ups_group7.xls','wrb') ## Change dynamicly
ws=wb.add_sheet(sheetname1)


## Gene_ID in other studies
import xlrd
Name_newfile=currentDirectory_comparison+'/'+'Nbenthi under pamar.xlsx'
